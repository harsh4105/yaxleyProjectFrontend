    ...
    <div className={`Countryblock-section-for-services ${props.class}`} style={{ backgroundColor: `${props.background}`, }}>
      <div className="Countryblock-left-section">
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginTop: '-15px' }}>
          <img src={props.bullets} alt="bullets" style={{ marginRight: '10px' }} />
          <span style={{ marginBottom: "5px" }}><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed</p></span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', marginTop: '-15px' }}>
          <img src={props.bullets} alt="bullets" style={{ marginRight: '10px' }} />
          <span style={{ marginBottom: "5px" }}><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed</p></span>
